...
Route::get('/home', [BookController::class, 'userIndex'])->name('home');
...
Route::middleware('auth')->group(function () {
    ...
    // 1. SETUP PROFIL AWAL
    Route::get('/name', [ProfileController::class, 'createName'])->name('name');
    Route::post('/name', [ProfileController::class, 'storeName'])->name('name.store');
